                    ...
                    <b-form id="mappingplank">
                        <div class="form-group row" id="modalrowsize">
                            <div class="form-group col-md-6">
                                ...
                                <b-form-input type="number" size="sx-2" id="r" min="0" max="50" v-model="r" style="width:60px; position: relative; left: 43%"></b-form-input>
                            </div>
                            <div class="form-group col-md-6">
...
export default{
    ...
    methods: {
       f(x){
           return (this.r*x)/(1+Math.pow(x,3))
       },
       fr(x,r){
            return (r*x)/(1+Math.pow(x,3))
       },
       fDiff(x,r){
           return Math.log(Math.abs((r-2*r*Math.pow(x,3))/(Math.pow((1+Math.pow(x,3)),2))))
       },
      chartMapping(){
          this.x = []
          this.y = []
      ...
      chartBifur(){
        this.rb = []
        for (let i = this.rmin; i < this.rMax; i = i+0.05) {
